...
cs = CustomStep(displayName="Search for Goofus")

cs.generate_readme(readme_file="EXAMPLE_README.md", description="This is a custom step that searches for Goofus in a dataset")
